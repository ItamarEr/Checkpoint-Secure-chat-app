...
// Please work using the Model Controllers and Services instead of direct model access
// The following code is commented out as it directly accesses models and should be refactored
// to use controllers and services for better separation of concerns and maintainability.
